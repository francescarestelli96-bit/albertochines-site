...
export const LanguageProvider = ({ children }: { children: React.ReactNode }) => {
  ...
  const translations: any = {
    it: {
      ...
      about: {
        title: "Bio",
        pressKitFull: "/downloads/presskit.zip",
...
Alberto Chines è docente di pianoforte presso il Conservatorio "Francesco Venezze" di Rovigo.`
      ...
      repertorio: {
        ...
        content: {
          ...
          rameau: "Suite in mi minore\nSuite in la minore\nLes Indes Galantes (tr. Dukas) - selezione",
...
Alberto Chines is a Piano Professor at the "Francesco Venezze" Conservatory in Rovigo.`
      ...
      repertorio: {
        ...
        content: {
          ...
          rameau: "Suite in E minor\nSuite in A minor\nLes Indes Galantes (tr. Dukas) - selection",
