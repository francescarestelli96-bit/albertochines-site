...
Il suo percorso formativo, ricco di incontri e masterclass con artisti di fama mondiale, si è consolidato presso l’Accademia di Imola sotto la guida di Franco Scala e Piero Rattalino, e al Conservatorio di Bolzano con Davide Cabassi. Dopo il debutto a soli quindici anni al Teatro Massimo di Palermo, si è imposto all’attentione della critica vincendo il primo premio al Concorso Internazionale Palma d’Oro di Finale Ligure (2011), il Sony Classical Talent Scout di Madesimo (2013) e il secondo premio all’Euregio Piano Award di Geilenkirchen (2014).
...
Alberto Chines è docente di pianoforte presso il Conservatorio “Francesco Venezze” di Rovigo.`
    ...
    repertorio: {
      ...
      solistico: `...`, // Mantieni il tuo elenco qui
      orchestra: `...` // Mantieni il tuo elenco qui
    },
    concerts: { title: "Concerti", message: "Date in aggiornamento" },
    media: { title: "Media" },
    contact: { title: "Contatti", inquiries: "" } // SVUOTATO
  },
  en: {
...
Alberto Chines currently serves as a Professor of Piano at the “Francesco Venezze” Conservatory in Rovigo.`
    ...
    media: { title: "Media" },
    contact: { title: "Contact", inquiries: "" } // SVUOTATO
  }
};
