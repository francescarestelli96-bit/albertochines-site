...
Alberto Chines è docente di pianoforte presso il Conservatorio "Francesco Venezze" di Rovigo.`
      ...
      repertoire: {
        ...
        content: [
          ...
          { composer: "J.S. BACH", works: "Partita N. 2 BWV 826, Suite Inglesi N. 2 & 3, Suite Francese N. 5, Toccata in mi minore BWV 914, Das wohltemperierte Klavier (selezione), Die Kunst der Fuge (selezione), Fantasia e Fuga in sol minore (tr. Liszt), Passacaglia e Fuga in do minore (tr. D’Albert), Toccata e Fuga in re minore (tr. Busoni), Concerto Brandeburghese N. 3 (tr. Friedman)" },
...
Alberto Chines is a Piano Professor at the "Francesco Venezze" Conservatory in Rovigo.`
      ...
      repertoire: {
        ...
        content: [
          ...
          { composer: "OTTORINO RESPIGHI", works: "Antiche Arie e Danze, Sonata for violin and piano P. 110" },
