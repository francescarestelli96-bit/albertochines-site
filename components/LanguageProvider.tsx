...
const DICTS: Record<Lang, Dictionary> = {
  it: {
    ...
    home: {
      tagline: "Un profilo essenziale dedicato all’interpretazione, al repertorio e all’attività concertistica.",
    },
  ...
  en: {
    ...
    home: {
      tagline: "An essential profile dedicated to interpretation, repertoire and concert activity.",
    },
