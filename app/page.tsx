...
export default function Home() {
  ...
  return (
    <main className="relative min-h-screen w-full bg-black overflow-hidden flex flex-col md:flex-row">
      ...
      <div className="relative z-10 w-full md:w-1/2 flex flex-col justify-center px-6 md:px-20 py-16 md:py-0 animate-in fade-in slide-in-from-left-12 duration-1000">
        <div className="max-w-xl">
          <h1 className="text-[2.6rem] sm:text-5xl md:text-6xl lg:text-7xl font-extralight uppercase tracking-[0.2em] md:tracking-[0.3em] text-white leading-tight">
            Alberto<br />Chines
          </h1>
          ...
          <div className="space-y-3">
            ...
            <p className="text-[8px] md:text-[10px] uppercase tracking-[0.3em] text-zinc-500 font-extralight">
              {t('home.tagline')}
            </p>
          </div>
        </div>
      ...
      {/* SEZIONE DESTRA: FOTO */}
      <div className="relative w-full md:w-1/2 h-[50vh] md:h-full animate-in fade-in md:slide-in-from-right-12 duration-1000 delay-300">
