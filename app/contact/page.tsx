...
import { Instagram, Facebook, Youtube, PlayCircle, Music2 } from "lucide-react";
...
const SocialIcon = ({ href, icon: Icon, isSpotify = false }: { href: string, icon?: any, isSpotify?: boolean }) => (
  <a href={href} target="_blank" rel="noopener noreferrer" className="text-zinc-600 hover:text-white transition-colors duration-300 flex items-center justify-center">
  ...
  return (
    <main className="min-h-screen bg-black text-white pt-40 px-6 pb-20 flex flex-col items-center">
      <div className="max-w-2xl w-full text-center space-y-12">
        ...
        <div className="grid grid-cols-4 md:grid-cols-7 gap-8 md:gap-6 justify-items-center w-full max-w-4xl mx-auto pt-10">
          <SocialIcon href="http://googleusercontent.com/spotify.com/8" isSpotify={true} />
