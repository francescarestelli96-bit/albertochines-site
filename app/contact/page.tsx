    ...
    <main className="min-h-screen bg-black text-white pt-32 px-8 flex items-center justify-center animate-in fade-in duration-1000">
      <div className="max-w-xl w-full text-center">
        ...
        <div className="space-y-16">
          ...
          {/* ICONE SOCIAL NATIVE (SVG) - NON RICHIEDONO INSTALLAZIONI */}
          <div className="flex justify-center gap-10 pt-10">
            ...
            {/* Instagram */}
            <a href="https://instagram.com/albertochines" className="text-zinc-500 hover:text-white transition-colors">
            ...
            {/* Facebook */}
            <a href="https://facebook.com/albertochines" className="text-zinc-500 hover:text-white transition-colors">
