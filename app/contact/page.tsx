...
export default function Contact() {
  ...
  return (
    <main className="min-h-screen bg-black text-white pt-32 flex items-center justify-center">
      <div className="max-w-xl w-full text-center">
        <h1 className="text-3xl md:text-4xl font-extralight uppercase tracking-[0.4em] mb-20">
          {t('contact.title')}
        </h1>
        <a href="mailto:info@albertochines.com" className="text-xl md:text-2xl font-light hover:text-zinc-400">
          info@albertochines.com
        </a>
        <div className="flex justify-center gap-10 pt-16">
          <a href="https://instagram.com/albertochines" target="_blank" className="text-zinc-500 hover:text-white">
