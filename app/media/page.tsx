...
export default function MediaPage() {
  ...
  // ID VIDEO REALI E VERIFICATI DAL CANALE DI ALBERTO CHINES E PARTNER
  const videos = [
  ...
  useEffect(() => {
    // Mescola l'ordine delle foto al caricamento per dinamismo
